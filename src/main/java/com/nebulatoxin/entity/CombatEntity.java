package com.nebulatoxin.entity;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import com.google.gson.stream.JsonReader;
import com.nebulatoxin.NTSystem;
import com.nebulatoxin.data.CombatAttribute;
import com.nebulatoxin.data.ItemType;
import com.nebulatoxin.roll.Roll;
...
public class CombatEntity {
    ...
    public CombatEntity(NTSystem system, String uuid, boolean saveNow) {
        attributes = new HashMap<>();
    ...
    public static CombatEntity findDefaults(NTSystem system, Entity entity) {
    ...
    public static CombatEntity findMob(NTSystem system, String name) {
        name = name
                .replaceAll("§[A-z,0-9]", "")
                .replace(" ", "") + ".json";
        String path = system.getDataFolder().getPath() + File.separator
    ...
    public static CombatEntity getPlayer(NTSystem system, Player player) {
        Gson gson = new Gson();
    ...
    public void savePlayer(NTSystem system, String uuid) {
        Gson gson = new GsonBuilder().setPrettyPrinting().create();
        String s = File.separator;
    ...
    public static CombatEntity parseFromJson(NTSystem system, String path) {
        Gson gson = new Gson();
        try {
    ...
    public void save(NTSystem system, String name) {
        Gson gson = new GsonBuilder().setPrettyPrinting().create();
        String json = gson.toJson(this);
        File file = new File(system.getDataFolder().getPath() + File.separator
